...
public class StreamingConfiguration {
    ...
    @Bean StreamingService streamingService(ConversationRepository conversations, StreamingRepository generations, DraftStore drafts, SseEventHub events) { return new StreamingService(conversations, generations, drafts, events); }
}
